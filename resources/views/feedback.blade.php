...
<article>
    ...
    <div class="container" style="padding-top: 5em" ng-controller="FeedbackCtrl">
        <div class="panel panel-primary">
            <div class="panel-heading">Felhasználói regisztráció</div>
                ...
                <form name="feedbackForm" novalidate>
                    ...
                    <div class="row">
                                ...
                                <div class="form-group col-md-6" ng-class="{ 'has-error': feedbackForm.confirmPassword.$touched && feedbackForm.confirmPassword.$invalid }">
                                    ...
                                    <div class="help-block" ng-messages="feedbackForm.confirmPassword.$error" ng-if="feedbackForm.confirmPassword.$touched">
                                        <p ng-message="compareTo">A két jelszó nem egyezik meg</p>
                                        <p ng-message="minlength">A jelszó túl rövid!</p>
                    ...
                    <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="interest" class="form-control" ng-model="feedback.interest">
                    ...
                    <div class="row">
                                ...
                                <div class="form-group col-md-6" ng-class="{ 'has-error': feedbackForm.law.$touched && feedbackForm.law.$invalid }">
                    ...
                    <div class="row">
                                <div class="col-md-12">
                                    <button type="submit" ng-disabled="feedbackForm.$invalid" class="btn btn-lg btn-primary" ng-click="save()">Elküldöm</button>
                                </div>
                    </div>
                </form>
            </div>
